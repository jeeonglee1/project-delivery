          ...
          <div className="flex justify-center h-full ">
            ...
            <div className="flex-columm justify-center items-center w-1/2 h-100% space-y-4">
                ...
                <div className="flex justify-center items-end w-full h-36 "> 
                    <h2 className="flex justify-center items-center w-full h-4 font-medium text-xl text-cinza-h2">McOferta BigTasty</h2>
                </div>
                
                <div className="flex-columm justify-center">            
                    <div className="flex justify-center items-center w-full pt-2.5 px-10">
                        <p className="flex justify-center items-center w-full h-auto font-light text-cinza-200 text-justify">Lorem ipsum  sit amet consectetur adipisicing elit. Quo sus asperiores odio ipsipsam laudantium, aperiam perferendis modi magni! Accusantium animi!</p>
                    </div>
